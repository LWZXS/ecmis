...
<html>
  ...
  <body>
	<table id="dg" title="个人待办" style="width:100%;height:100%;"
		...
		<thead>
			<!-- <tr>
				...
				<th data-options="field:'creationUser',width:80,align:'left'">创建人</th>
				<th data-options="field:'creationDate',width:100,align:'center',resizable:true,sortable:true,order:'desc'">创建日期</th>
		...
		$(function(){
			$('#dg').datagrid({
			    ...
			    onDblClickRow:function(rowIndex,rowData){
			    	//alert(rowData.documentStatus.docStatusId);
			    	/* switch(rowData.documentStatus.docStatusId){
			    		case 1:
			    			alert('新建');
			    			break;
		    			case 2:
			    	...
			    	//rest风格
			    	window.location.href='/ecmis/document/view/'+rowData.documentId+'/list';
