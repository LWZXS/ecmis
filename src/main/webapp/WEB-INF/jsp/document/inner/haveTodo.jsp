		...
		$(function(){
			$('#dg').datagrid({
			    ...
			    onDblClickRow:function(rowIndex,rowData){
			    	window.location.href='/ecmis/document/haveTodo/'+rowData.documentId+'/haveTodo';
			    },
				columns:[[
					{field:'documentName',title:'文档名称', width:150,align:'left',resizable:true},
					{field:'company',title:'来源', width:150,align:'left',resizable:true,
					...
					{field:'creationUser',title:'创建人', width:100,align:'left',resizable:true,
						formatter: function(value,row,index){
							if (row.creator){
					...
					{field:'creationDate',title:'创建日期', width:150,align:'center',resizable:true},
					{field:'subjectTermName',title:'主题词', width:100,align:'left',resizable:true},
					{field:'attachment',title:'附件', width:200,align:'left',resizable:true},
					{field:'documentStatus',title:'状态', width:150,
						formatter: function(value,row,index){
