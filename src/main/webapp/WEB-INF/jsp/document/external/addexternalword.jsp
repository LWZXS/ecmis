...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	String stroper = (String) request.getAttribute("opr");
	//要打开的文件名
	String docName = (String) request.getAttribute("docName");
	//要保存的文件名
	String mainBody = (String) request.getAttribute("mainBody");
	//office类型
...
<html>
  ...
  <body>
	<form action="WebDocEdit.jsp?oper=<%=stroper%>" name="frm" method="post" onsubmit="return WebSave()">
		...
		<input type="hidden" value="<%=basePath %>uploadExternalDocumentMainBody.jsp" id="url" name="url">
		...
		<!-- 文件名： -->
		<input type="hidden" class="text" style="width:280px" name="fname" value="<%=strfname%>">
	    <input type="button" class="button" value="立即保存" style="width:80px;" onclick="WebHttpSave();">
