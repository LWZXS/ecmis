...
<html>
  ...
  <body>
	<div id="nav" style="padding:3px; margin-bottom: 5px;">
    ...
    <div style="width:100%;height:100%;">
		<div>
			<!-- 内部文档中  最外层的iframe -->
			<iframe name="contentIframe" id="contentIframe"  scrolling="no" frameborder="0"  src="document/inner.html" style="width:100%;height:100%;"></iframe>
		</div>
	</div>
