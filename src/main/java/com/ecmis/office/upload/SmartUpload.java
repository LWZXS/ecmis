...
public class SmartUpload {
    ...
    public int save(String paramString) throws ServletException, IOException, SmartUploadException {
        return save(paramString, 0);
    }

    public int save(String paramString, int paramInt) throws ServletException, IOException, SmartUploadException {
        int i = 0;
        if (paramString == null) {
