...
<head>
  ...
  <body>
	<table id="dg" title="文档类型管理" style="width:100%;height: 100%;"
	...
	<div id="tb">
		<form action="" id="searchFrm">
            <label for="documentTypeName" style="margin-left: 5px;"></label>文档类型名称:<input style="height: 22px;" class="easyui-textbox" id="documentTypeName" name="documentTypeName" type="search" placeholder="文档类型名称..." >
			状态:
			...
			分类级别:
			<select class="easyui-combobox" panelHeight="auto" style="width:100px" name="levelId" id="s_levelId">
				<option value="">全部</option>
	...
	<div>
		<!-- 增加文档类型Dialog start-->
		<div id="add-documentType-dlg" class="easyui-dialog" closed="true" title="增加文档类型"
			style="width:600px;height:380px;padding:10px;"
				data-options="buttons:'#add-documentType-buttons'">
			<div style="margin:20px 0;"></div>
			<div title="" style="width:560px;">
				<div style="padding:10px 60px 20px 60px">
			    <form id="ff" method="post" enctype="multipart/form-data" >
					<input name="opr" value="add" type="hidden" id="opr"/>
					<input name="levelId" value="" type="hidden" id="levelId"/>
			    	<table cellpadding="5">
			    		<tr>
			    			<td>编号:</td>
		...
		<div id="add-documentType-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:$('#add-documentType-dlg').dialog('close')">关闭</a>
		</div>
		<!-- 增加文档类型Dialog end-->
	</div>
	<script type="text/javascript">
		$(function(){
            ...
            $("#update").click(function () {
                ...
                $("#opr").val("update");
                if (documentType){
                    $('#add-documentType-dlg').dialog({
                        title: '修改文档类型'
                    });
                    //
                    $("#add-documentType-dlg").dialog("open");
...
*/
			...
			$('#dg').datagrid({
				url:'${pageContext.request.contextPath}/documentType/list.json',
				/* queryParams: {
				...
				columns:[[
					...
					{field:'docTypeId',title:'编号', width:10,align:'center',resizable:true},
					{field:'docTypeName',title:'文档类型名称', width:45,align:'left',resizable:true},
                    {field:'parentDocTypeName',title:'上级名称(编号)', width:40,align:'left',resizable:true},
                    {field:'docName',title:'存档文件', width:20,align:'left',resizable:true},
			...
			$("#searchBtn").click(function(){
				...
				$('#dg').datagrid({
					url:'${pageContext.request.contextPath}/documentType/list.json?'+s
				});
			});	
